   class Jeops_RuleBase_RegrasPokemon extends jeops.AbstractRuleBase {
     ...
     * <code>!am.getMapaElemento().existeElementoProximo(am.getAgente().getPosicao())</code>
     *
     * @return <code>true</code> if the condition is satisfied;
     *          <code>false</code> otherwise.
     */
    private boolean AndarAleatoriamente_cond_0() {
        return (!AgenteMapa_1.getMapaElemento().existeElementoProximo(AgenteMapa_1.getAgente().getPosicao()));
    }
